...
def autorec(matrix_train, matrix_valid, matrix_unif_train, iteration=100, lam=0.01, rank=50, seed=0,
    ...
    if way == 'unif':
        RQ, X, xBias, Y, yBias = model.train_model(matrix_unif_train, matrix_valid, iteration, metric_names)
    elif way == 'combine':
